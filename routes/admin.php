...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('ManageUsersController')->name('users.')->prefix('users')->group(function () {
        ...
        Route::get('employment-history/{id}', 'employmentHistory')->name('employment.history');
        Route::get('educational-qualification/{i}', 'educationalQualification')->name('educational.qualification');
        Route::get('applied/job/{id}', 'appliedJob')->name('applied.job');
    });

    // Employer Manager
    Route::controller('ManageEmployeeController')->name('employers.')->prefix('employers')->group(function () {
        Route::get('/', 'all')->name('all');
        Route::post('featured/{id}', 'featuredEmployer')->name('featured');
    ...
    //industry route
    Route::controller('IndustryController')->name('industry.')->prefix('industry')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::post('/save/{id?}', 'store')->name('save');
        Route::post('/status/{id}', 'changeStatus')->name('status');
    });
    ...
    //plan route =======start 19-11-22 3.47 pm
    Route::controller('PlanController')->name('plan.')->prefix('plan')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::post('/save/{id?}', 'save')->name('save');
        Route::post('/status/{id}', 'status')->name('status');
        Route::get('/subscriber/list/{id?}', 'planSubscriberList')->name('subscriber.list');
    });
    ...
    Route::controller('LocationController')->name('location.')->prefix('location')->group(function () {
        ...
        Route::get('/', 'location')->name('index');
        Route::post('/save/{id?}', 'locationSave')->name('save');
        Route::post('/status/{id}', 'status')->name('status');
    });

    //education route
    Route::controller('EducationController')->name('education.')->prefix('education')->group(function () {
        Route::name('level.')->prefix('level')->group(function () {
            Route::get('/', 'index')->name('index');
            Route::post('/save/{id?}', 'save')->name('save');
            Route::post('/status/{id}', 'changeLevelsStatus')->name('status');
        });

        Route::name('degree.')->prefix('degree')->group(function () {
            Route::get('/', 'degree')->name('index');
            Route::post('/save/{id?}', 'degreeSave')->name('save');
            Route::post('/status/{id}', 'changeDegreeStatus')->name('status');
        });

        Route::name('group.')->prefix('group')->group(function () {
            Route::get('/', 'group')->name('index');
            Route::post('/save/{id?}', 'groupStore')->name('save');
            Route::post('/status/{id}', 'changeGroupStatus')->name('status');
        });
    });

    //skill route
    Route::controller('SkillController')->name('skill.')->prefix('skill')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::post('/save/{id?}', 'store')->name('save');
        Route::post('/status/{id}', 'changeStatus')->name('status');
    });
    ...
    //experience route
    Route::controller('ExperienceController')->name('experience.')->prefix('experience')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::post('/save/{id?}', 'store')->name('save');
        Route::post('/status/{id}', 'changeStatus')->name('status');
    });
    ...
    //type route
    Route::controller('TypeController')->name('type.')->prefix('type')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::post('/save/{id?}', 'store')->name('save');
        Route::post('/status/{id}', 'changeStatus')->name('status');
    });
    ...
    //salary period
    Route::controller('SalaryPeriodController')->name('salary.period.')->prefix('salary')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::post('/save/{id?}', 'store')->name('save');
        Route::post('/status/{id}', 'changeStatus')->name('status');
    });
    ...
    //number of employee
    Route::controller('NumberOfEmployeeController')->name('number.of.employee.')->prefix('number/of/employee')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::post('/save/{id?}', 'store')->name('save');
        Route::post('/status/{id}', 'changeStatus')->name('status');
    });

    Route::controller('JobController')->name('jobs.')->prefix('jobs')->group(function () {
        Route::get('/', 'all')->name('index');
        Route::get('pending', 'pending')->name('pending');
        Route::get('approved', 'approved')->name('approved');
        Route::get('reject', 'rejected')->name('rejected');
