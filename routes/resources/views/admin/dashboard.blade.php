...
@section('panel')
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <x-widget link="{{ route('admin.employers.all') }}" style="7" type="2" icon="las la-users"
                      title="Total Employers" value="{{ $widget['total_employers'] }}" bg="primary" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget link="{{ route('admin.employers.active') }}" style="7" type="2" icon="las la-user-check"
                      title="Active Employers" value="{{ $widget['verified_employers'] }}" bg="success" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget link="{{ route('admin.employers.email.unverified') }}" style="7" type="2"
                      icon="las la-envelope" title="Email Unverified Employers"
                      value="{{ $widget['email_unverified_employers'] }}" bg="danger" />
        </div>
        <div class="col-xxl-3 col-sm-6">
            <x-widget link="{{ route('admin.employers.mobile.unverified') }}" style="7" type="2"
                      icon="las la-comment-slash" title="Mobile Unverified Employers"
                      value="{{ $widget['mobile_unverified_employers'] }}" bg="red" />
        </div>
    </div>
    <div class="row mt-2 gy-4">
        ...
        <div class="col-xxl-6">
            <div class="card box-shadow3 h-100">
                <div class="card-body">
                    <h5 class="card-title">@lang('Jobs')</h5>
                    <div class="widget-card-wrapper">
                        <div class="widget-card bg--primary">
                            <a href="{{ route('admin.jobs.index') }}" class="widget-card-link"></a>
                            <div class="widget-card-left">
                                <div class="widget-card-icon">
                                    <i class="fas fa-hand-holding-usd"></i>
                                </div>
                                <div class="widget-card-content">
                                    <h6 class="widget-card-amount">{{ $widget['total_jobs'] }}</h6>
                                    <p class="widget-card-title">@lang('Total Jobs')</p>
                                </div>
                            </div>
                            <span class="widget-card-arrow">
                                <i class="las la-angle-right"></i>
                        ...
                        <div class="widget-card bg--success">
                            <a href="{{ route('admin.jobs.approved') }}" class="widget-card-link"></a>
                            <div class="widget-card-left">
                                <div class="widget-card-icon">
                                    <i class="fas fa-spinner"></i>
                                </div>
                                <div class="widget-card-content">
                                    <h6 class="widget-card-amount">{{ $widget['approved_jobs'] }}</h6>
                                    <p class="widget-card-title">@lang('Approved Job')</p>
                                </div>
                            </div>
                            <span class="widget-card-arrow">
                                <i class="las la-angle-right"></i>
                        ...
                        <div class="widget-card bg--warning">
                            <a href="{{ route('admin.jobs.pending') }}" class="widget-card-link"></a>
                            <div class="widget-card-left">
                                <div class="widget-card-icon">
                                    <i class="fas fa-ban"></i>
                                </div>
                                <div class="widget-card-content">
                                    <h6 class="widget-card-amount">{{ $widget['pending_jobs'] }}</h6>
                                    <p class="widget-card-title">@lang('Pending Jobs')</p>
                                </div>
                            </div>
                            <span class="widget-card-arrow">
                                <i class="las la-angle-right"></i>
                        ...
                        <div class="widget-card bg--danger">
                            <a href="{{ route('admin.jobs.rejected') }}" class="widget-card-link"></a>
                            <div class="widget-card-left">
                                <div class="widget-card-icon">
                                    <i class="fas fa-percentage"></i>
                                </div>
                                <div class="widget-card-content">
                                    <h6 class="widget-card-amount">{{ $widget['rejected_jobs'] }}</h6>
                                    <p class="widget-card-title">@lang('Rejected Job')</p>
                                </div>
                            </div>
                            <span class="widget-card-arrow">
                                <i class="las la-angle-right"></i>
