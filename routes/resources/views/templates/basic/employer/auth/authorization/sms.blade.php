        ...
        <div class="d-flex justify-content-center">
            <div class="verification-code-wrapper">
                <div class="verification-area">
                    ...
                    <form action="{{ route('employer.verify.mobile') }}" method="POST" class="submit-form disableSubmission">
                        @csrf
                        <p class="pb-3">
                            @lang('A 6 digit verification code sent to your mobile number') :
                            +{{ showMobileNumber(authUser('employer')->mobile) }}
                        </p>
                        ...
                        <div class="mt-3">
                            <p>
                                ...
                                <a href="{{ route('employer.send.verify.code', 'sms') }}"
