                    ...
                    <div class="row gy-4 justify-content-center">
                        <div class="col-sm-6">
                            <x-widget link="javascript:void(0)" style="6" icon="fas fa-list" :title="$viaText . ' should be sent'"
                                value="{{ @$sessionData['total_employer'] }}" bg="primary" :viewMoreIcon=false />
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <x-widget link="javascript:void(0)" style="6" icon="fa-solid fa-paper-plane" :title="$viaText . ' has yet to be sent'"
                                :viewMoreIcon=false value="{{ @$sessionData['total_employer'] - @$sessionData['total_sent'] }}"
                                bg="warning" />
                        </div>
                        <div class="col-sm-6">
                                ...
                                <div class="card-body p-5 text-center">
                                    <div class="coaling-loader flex-column d-flex justify-content-center">
                                        ...
                                        <p class="text--primary">
                                            @lang(' ' . @$sessionData['total_sent'] . ' out of ' . @$sessionData['total_employer'] . ' ' . $viaName . ' were successfully transmitted')
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="being_sent_to" required
                                        ...
                                        @foreach ($notifyToEmployer as $key => $toUser)
        ...
        (function($) {
            ...
            $('select[name=being_sent_to]').on('change', function(e) {
                ...
                if (methodName == 'SELECTEDEMPLOYERS') {
                    ...
                    <div class="form-group" id="user_list_wrapper">
                        <label class="required">@lang('Select Employer')</label>
                ...
                if (methodName == 'TOPDEPOSITEDEMPLOYERS') {
                    $('.input-append').html(`
                    <div class="form-group">
                        <label class="required">@lang('Number Of Top Payment Employer')</label>
            ...
            function fetchUserList() {
                $('.row #user_list').select2({
                    ajax: {
                        url: "{{ route('admin.employers.list') }}",
                        type: "get",
                        dataType: 'json',
                        delay: 1000,
            ...
            function getUserCount(methodName) {
                ...
                var route = "{{ route('admin.employers.segment.count', ':methodName') }}"
