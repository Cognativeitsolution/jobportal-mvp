                ...
                <form method="post">
                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item flex-sm-nowrap gap-2">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Employer Registration')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you disable this module, no one can register on this system as a employer.')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                        data-offstyle="-danger" data-bs-toggle="toggle" data-height="35"
                                        data-on="@lang('Enable')" data-off="@lang('Disable')" name="employer_registration"
                                        @if (gs('employer_registration')) checked @endif>
                                </div>
                            </li>
                            <li class="list-group-item flex-sm-nowrap gap-2">
                                <div>
                            ...
                            <li class="list-group-item flex-sm-nowrap gap-2">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Paid Job Post')</p>
                                    <p class="mb-0">
                                        <small>
                                            @lang('If you enable this module, employers can be post job by expense a minimum amount of money which is controllable by admin.')
                                            <a href="{{ route('admin.plan.index') }}" target="_blank">@lang('Setting here')</a>
                                        </small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                        data-offstyle="-danger" data-bs-toggle="toggle" data-height="35"
                                        data-on="@lang('Enable')" data-off="@lang('Disable')" name="job_post_payment"
                                        @if (gs('job_post_payment')) checked @endif>
                                </div>
                            </li>
                            <li class="list-group-item flex-sm-nowrap gap-2">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Free Job Post')</p>
                                    <p class="mb-0">
                                        <small>
                                            @lang('If you enable this module, employers can be post free job if they have free job post limit.')
                                            <a href="{{ route('admin.plan.index') }}" target="_blank">@lang('Setting here')</a>
                                        </small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success"
                                        data-offstyle="-danger" data-bs-toggle="toggle" data-height="35"
                                        data-on="@lang('Enable')" data-off="@lang('Disable')" name="free_job_post"
                                        @if (gs('free_job_post')) checked @endif>
                                </div>
                            </li>
                        </ul>
                    </div>
