...
class ProcessController extends Controller
{
    ...
    public static function process($deposit)
    {
        ...
        $val['name'] = auth()->guard('employer')->user()->username;
        $val['description'] = "Payment By Razorpay";
        $val['image'] = siteLogo();
        $val['prefill.name'] = auth()->guard('employer')->user()->firstname . ' ' . auth()->guard('employer')->user()->lastname;
        $val['prefill.email'] = auth()->guard('employer')->user()->email;
        $val['prefill.contact'] = auth()->guard('employer')->user()->mobileNumber;
        ...
        $send['view'] = 'employer.payment.'.$alias;
