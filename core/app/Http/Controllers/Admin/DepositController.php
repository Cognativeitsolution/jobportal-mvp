...
class DepositController extends Controller {
    ...
    protected function depositData($scope = null, $summary = false, $userId = null) {
        ...
        if ($userId) {
            $deposits = $deposits->where('employer_id', $userId);
        }

        $deposits = $deposits->searchable(['trx', 'employer:username'])->dateFilter();
        $request  = request();
    ...
    public function details($id) {
        ...
        $pageTitle = $deposit->employer->username . ' requested ' . showAmount($deposit->amount);
