...
class RegisterController extends Controller
{
    ...
    protected function create(array $data)
    {
        ...
        $user->profile_update_percent_list = gs('resume_percentage');
        $user->save();
        ...
        if ($user->ev) {
            $user->profile_update_percent += $profileUpdatePercentList['email_verification'];
            unset($profileUpdatePercentList['email_verification']);
            $user->profile_update_percent_list = $profileUpdatePercentList;
            $user->save();
        }

        if ($user->sv) {
            $user->profile_update_percent += $profileUpdatePercentList['mobile_verification'];
            unset($profileUpdatePercentList['mobile_verification']);
            $user->profile_update_percent_list = $profileUpdatePercentList;
            $user->save();
        }
