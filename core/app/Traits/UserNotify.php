...
trait UserNotify
{
    public static function notifyToUser()
    {
        return [
            ...
            'profileNotCompleteUsers' => 'Profile Not Complete Users',
            'notAppliedJob'           => 'Not Applied Job Users',
            'rejectedJobApplyUsers'   => 'Rejected Job Apply Users',
        ];
    }
    ...
    public function scopeNotAppliedJob($query)
    {
        return $query->whereDoesntHave('jobApplies');
    }

    public function scopeRejectedJobApplyUsers($query)
    {
        return $query->whereHas('jobApplies',function($jobApplies){
            $jobApplies->where('status', Status::JOB_APPLY_REJECTED);
        });
    }
    ...
    public function scopeProfileNotCompleteUsers($query)
    {
        return $query->where('profile_update_percent', '<', 100);
    }
}
