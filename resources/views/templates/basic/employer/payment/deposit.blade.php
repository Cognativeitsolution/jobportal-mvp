...
@php
    ...
    if (session()->has('job_id')) {
        $amount = getAmount(gs('fee_per_job_post'));
    }
@endphp
@section('content')
        ...
        <div class="col-xxl-8 col-xl-10">
            <div class="card-item wow fadeInUp" data-wow-duration="2s">
                ...
                <div class="card-item__inner">
                    <form action="{{ route('employer.deposit.insert') }}" method="post" class="deposit-form">
                        @csrf
                                            ...
                                            <label for="{{ titleToKey($data->name) }}"
                                                ...
                                                <span class="payment-check d-none">
                                                    <input class="payment-item__radio gateway-input"
                                                           id="{{ titleToKey($data->name) }}" type="radio" name="gateway"
                                    ...
                                    <div class="payment-system-list p-3">
                                        <div class="deposit-info">
                                            ...
                                            <div class="deposit-info__input">
                                                <p class="text">
                                                    <span class="text">{{ showAmount($amount) }}</span>
                                                </p>
                                            </div>
                                            <input type="text" hidden class="form--control amount" name="amount"
