                        ...
                        <table class="table table--light style--two">
                            ...
                            <tbody>
                                @forelse($data as $type)
                                    <tr>
                                        <td>{{ __(ucfirst($type->name)) }}</td>
                                        <td>@php echo $type->statusBadge; @endphp</td>
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='@json($type->only('id', 'name'))''>
...
@push('script')
    <script>
        ...
        (function($) {
            ...
            let modal = $("#my-modal");
            let action = `{{ route('admin.type.save') }}`;

            $('.add-btn').on('click', function(e) {
                modal.find('.modal-title').text("@lang('New Type')");
            ...
            $('.edit-btn').on('click', function(e) {
                let action = `{{ route('admin.type.save', ':id') }}`;
                let data = $(this).data('edit');
                modal.find('.modal-title').text("@lang('Update Type')");
