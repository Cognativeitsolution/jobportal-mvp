...
class AdminController extends Controller {
    ...
    public function dashboard() {
        ...
        $widget['total_employers']             = Employer::count();
        $widget['verified_employers']          = Employer::active()->count();
        $widget['email_unverified_employers']  = Employer::emailUnverified()->count();
        $widget['mobile_unverified_employers'] = Employer::mobileUnverified()->count();

        $widget['total_jobs']    = Job::count();
        $widget['approved_jobs'] = Job::approved()->count();
        $widget['pending_jobs']  = Job::pending()->count();
        $widget['rejected_jobs'] = Job::rejected()->count();
